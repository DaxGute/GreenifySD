...
<LoginModal bind:modalVis = {modalDisplay}/>
{#if !modalDisplay}
    <div class="inline-flex items-center absolute bottom-10 left-1/2 -translate-x-1/2">
        ...
        <button on:click = "{toggleModal}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-10 rounded">Plant Trees</button>
